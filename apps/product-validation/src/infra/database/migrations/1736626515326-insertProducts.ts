...
export class InsertProducts1736626515326 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.manager.insert(ProductSchema, product2 as QueryDeepPartialEntity<ProductSchema>);
        await queryRunner.manager.insert(ProductSchema, product3 as QueryDeepPartialEntity<ProductSchema>);
        await queryRunner.manager.insert(ProductSchema, product4 as QueryDeepPartialEntity<ProductSchema>);
