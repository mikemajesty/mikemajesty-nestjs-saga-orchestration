...
export class InsertInventory1737161914764 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.manager.insert(InventorySchema, product2 as QueryDeepPartialEntity<InventorySchema>);
        await queryRunner.manager.insert(InventorySchema, product3 as QueryDeepPartialEntity<InventorySchema>);
        await queryRunner.manager.insert(InventorySchema, product4 as QueryDeepPartialEntity<InventorySchema>);
